...
def main():
    ...
    kwargs = {'num_workers': 4, 'pin_memory': True} if args.mps else {}
    ...
    for epoch in range(args.start_epoch, args.epochs + 1):
        ...
        acc, loss = test(val_loader, tnet, criterion, epoch)
...
def train(train_loader, tnet, criterion, optimizer, epoch):
    ...
    for batch_idx, (data1, data2, data3, c) in enumerate(train_loader):
        if args.mps:
            data1, data2, data3, c = data1.mps(), data2.mps(), data3.mps(), c.mps()
...
class VisdomLinePlotter(object):
    ...
    def plot(self, var_name, split_name, x, y, env=None):
        ...
        if var_name not in self.plots:
            ...
            # updateTrace not in new version, viz.line or viz.scatter
