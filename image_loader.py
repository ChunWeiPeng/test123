...
filenames = {'train': ['season_tripletlist_train.txt', 'gender_tripletlist_train.txt',
                       'usage_tripletlist_train.txt', 'category_tripletlist_train.txt'],
             'val': ['season_tripletlist_val.txt', 'gender_tripletlist_val.txt',
                     'usage_tripletlist_val.txt', 'category_tripletlist_val.txt'],
             'test': ['season_tripletlist_test.txt', 'gender_tripletlist_test.txt',
                      'usage_tripletlist_test.txt', 'category_tripletlist_test.txt']}
