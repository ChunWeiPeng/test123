...
filenames = {'train': ['gender_tripletlist_train.txt','category_tripletlist_train.txt', 
                       'colour_tripletlist_train.txt', 'type_tripletlist_train.txt'],
             'val': ['gender_tripletlist_val.txt','category_tripletlist_val.txt', 
                       'colour_tripletlist_val.txt', 'type_tripletlist_val.txt'],
             'test': ['gender_tripletlist_test.txt','category_tripletlist_test.txt', 
                       'colour_tripletlist_test.txt', 'type_tripletlist_test.txt']}
